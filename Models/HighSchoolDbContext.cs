...
public partial class HighSchoolDbContext : DbContext
{
    ...
    public virtual DbSet<StudentGradeInfo> StudentGradeInfos { get; set; }

    public virtual DbSet<TeacherCoursesView> TeacherCoursesViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD63620E9E");
        ...
        modelBuilder.Entity<StudentGradeInfo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("StudentGradeInfo");
        ...
        modelBuilder.Entity<TeacherCoursesView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TeacherCoursesView");
